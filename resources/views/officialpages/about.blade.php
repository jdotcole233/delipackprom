...
<section class="introsection">
    <div>
        <img src="{{asset('images/values.png')}}" alt="">
    </div>
    <div>
        <h1>Our Aim</h1> <br>
...
<section class="whysection">
    ...
    <!-- <p> To provide {you as a} delivery companies with state of the art technologies that makes your helps you keep an 
    track of delivery records, riders as well an overall statistics with your company data. </p>
    <p>To make life easier for every delipack customer in Ghana. We find the closest and most appropriate riders to 
    serve your need.</p> -->
</section>
