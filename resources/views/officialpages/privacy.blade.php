...
<section class="container">
    <div>
        ...
        <p>DeliPack ("us", "we", or "our") operates the DeliPack mobile application (hereinafter referred to as the "Service").</p>
        ...
        <ul>
            <li>
                <p><strong>Service</strong></p>
                        <p>Service is the DeliPack mobile application operated by DeliPack</p>
                    </li>
            <li>
        ...
        <h2>Use of Data</h2> 
        <p>DeliPack uses the collected data for various purposes:</p>    
        <ul>
        ...
        <p>DeliPack may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of DeliPack</li>
        ...
        <ul>
                <li>By email: support@delivpack.com</li>
                    <li>By visiting this page on our website: https://www.delivpack.com</li>
            
                <li>By phone number: 0503848404</li>
                </ul>
